...
def login():
    ...
    # 🔥 Probeer Spotify direct te openen via een deeplink
    spotify_auth_url = f"spotify:open-url:{auth_url}"

    return render_template("force_browser.html", auth_url=spotify_auth_url)
